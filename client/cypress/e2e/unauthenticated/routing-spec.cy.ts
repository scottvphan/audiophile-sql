...
describe("tests the earphone category page", () => {
    beforeEach(() => {
        cy.visit("/products/earphones");
    });

    it("opens the earphone details page", () => {
        cy.get("#yx1-earphones-btn").click();
    });

    it(
        "opens the mobile earphone details page",
        {
            viewportWidth: 412,
            viewportHeight: 892,
        },
...
describe("tests the speaker category page", () => {
    beforeEach(() => {
        cy.visit("/products/speakers");
    });

    it("opens the speaker details page", () => {
        cy.get("#zx9-speaker-btn").click();
    });

    it(
        "opens the mobile speaker details page",
        {
            viewportWidth: 412,
            viewportHeight: 892,
        },
...
describe("tests the headphone category page", () => {
    beforeEach(() => {
        cy.visit("/products/headphones");
    });

    it("opens the headphone details page", () => {
        cy.get("#xx99-mark-two-headphones-btn").click();
    });

    it(
        "opens the mobile headphone details page",
        {
            viewportWidth: 412,
            viewportHeight: 892,
        },
