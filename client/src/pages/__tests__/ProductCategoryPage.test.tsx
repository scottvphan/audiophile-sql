    ...
    data: [
...

        {
            ...
            features:
                ...
                "\n" +
                "The ZX7 speaker is the perfect blend of stylish design and high performance. It houses an encased MDF wooden enclosure that minimizes acoustic resonance. Dual connectivity allows pairing through Bluetooth or traditional optical and RCA input. Switch input sources and control volume at your fingertips with the included wireless remote. This versatile speaker is equipped to deliver an authentic listening experience.",
...

        {
            ...
            features:
                ...
                "\n" +
                "Discover clear, more natural-sounding highs than the competition with ZX9’s signature planar diaphragm tweeter. Equally important is its powerful room-shaking bass courtesy of a 6.5” aluminum alloy bass unit. You’ll be able to enjoy equal sound quality whether in a large room or a small den. Furthermore, you will experience new sensations from old songs since it can respond to even the subtle waveforms.",
...
const rendered = (props: any) =>
    render(<ProductCategoryPage {...props} />, { wrapper: MemoryRouter });

describe("Renders Product Category Page", () => {
    it("Fully renders with product categories", () => {
        rendered(props);
        screen.debug();
    });
});
