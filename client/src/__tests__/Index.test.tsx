...
const rendered = () => render(<Index {...props} />);
...
describe("Renders Index with a loader", () => {
    
    it("Renders Index with the loader component", () => {
        act(() => {
            const dataNotLoadedProps = {
                ...props,
                dataLoaded: false
            }
            render(<Index {...dataNotLoadedProps} />)
